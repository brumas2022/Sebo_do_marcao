...
st.markdown(":violet[Já pensou o dia em que o Papa se tocar]")
st.markdown(":violet[E sair pelado pelaItalia a cantar...]")
st.markdown(":violet[Quando acabar o maluco sou eu] :musical_note:")
