...
st.markdown(":violet[Foi Deus que fez a noite e um violão plangente]")
st.markdown(":violet[Foi Deus que fez a gente somente para amar, só para amar]")
st.markdown(":violet[Só para amar] :musical_note:")
...
cols = st.columns((1,1))
cols[0].link_button("Loja pague menos", "https://mais.app/1Nm5y9", use_container_width=True)
